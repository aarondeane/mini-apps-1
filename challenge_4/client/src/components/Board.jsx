...
class Board extends React.Component {
    ...
    render() {
        ...
        <div className="container">
            ...
            <div id="col1" className="board-column">
            ...
            <div id="col2" className="board-column">
            ...
            <div id="col3" className="board-column">
            ...
            <div id="col4" className="board-column">
            ...
            <div id="col5" className="board-column">
            ...
            <div id="col6" className="board-column">
            ...
            <div id="col7" className="board-column">
            ...
            <div id="col8" className="board-column">
